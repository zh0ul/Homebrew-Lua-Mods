function Custom_QuantumCube:Awake()
...
function Custom_QuantumCube:Null(obj)
  if obj then
...
function Custom_QuantumCube:Update()
...
function Custom_QuantumCube:DestroyObjects()
...
function Custom_QuantumCube:OnDestroy()
  self:DestroyObjects()
  HBU.EnableGadgetMouseScroll()
  Camera.main.fieldOfView = self.defaultFoV
end

function Custom_QuantumCube:HandleInventory()
...
function Custom_QuantumCube:DestroyIfPresent(go)
  if not self:Null(go) then GameObject.Destroy(go) end
end
function Custom_QuantumCube:UpdateTarget(go)
  ...
  function Custom_QuantumCube:Bezier(a, b, c, f)
  ...
  function Custom_QuantumCube:CreateCantSpawn()
  ...
  function Custom_QuantumCube:CreateTarget()
...
function Custom_QuantumCube:OpenBrowser()
...
function Custom_QuantumCube:CreateInventoryBar()
...
function Custom_QuantumCube:UpdateInventoryBar()
